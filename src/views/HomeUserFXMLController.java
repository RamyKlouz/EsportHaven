...
public class HomeUserFXMLController implements Initializable {
    ...
    private void Authentifier(ActionEvent event) {
            ...
            else if (resultat.equals("Votre compte est banner "))
            {
                ...
                alert.show();
            }else if(loginuser.getText().equals("user") && motdepasseuser.getText().equals("user")){
                ...
                stage.close();
                try {
                    parent = FXMLLoader.load(Objects.requireNonNull(HomeUserFXLM.class.getResource("/GUI/ClientSide.fxml")));
