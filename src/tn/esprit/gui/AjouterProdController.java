...
public class AjouterProdController implements Initializable {
    ...
    @FXML
    private TableColumn<Commande, String> cuser;
    @FXML
    private TableColumn<Commande, Integer> csomme1;
    @FXML
    ...
    public void update() {
        ...
        ObservableList<Commande> datacmd = FXCollections.observableArrayList(cs.afficher());
        cuser.setCellValueFactory(new PropertyValueFactory<Commande, String>("client"));
        csomme1.setCellValueFactory(new PropertyValueFactory<Commande, Integer>("somme"));
        tablecommandes.setItems(datacmd);
    ...
    private void deleteCmd(ActionEvent event) {
        ...
        if (tablecommandes.getSelectionModel().getSelectedItem() != null) {
            Commande p = tablecommandes.getSelectionModel().getSelectedItem();
            ps.supprimer(p.getOrderID());
        }
    ...
    private void back(ActionEvent event) {
        Stage stage1 = (Stage) btnsuppcmd.getScene().getWindow();
                      stage1.close();  
                      try {
