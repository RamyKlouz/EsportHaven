...
public class JoueurController implements Initializable {
    ...
    private void insertRecord() throws IOException {
        ...
        String query = "INSERT INTO joueur VALUES(" + tfName.getText() + "','" + tfLast.getText() + "','" + tfMail.getText() + "','" + tfPass.getText() + "','" + Gender + "'," + tfPhone.getText() + ",'" + tfBir.getText() + "')";
        executeQuery(query);
...
//        tray.showAndDismiss(Duration.millis(2000));
    ...
    private void back(ActionEvent event) {
         Stage stage1 = (Stage) tfPhone.getScene().getWindow();
                      stage1.close();  
                      try {
